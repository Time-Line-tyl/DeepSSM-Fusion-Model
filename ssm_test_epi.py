...
latent_csv = os.path.join(root, "latent_ssm_epi.csv")
split_txt = os.path.join(root, "split_test.txt")

# ======= 明确实验和权重参数 =======
exp_name = "epi_attn_20250615_231746"
exp_baseline = "epi_baseline_20250615_022503"
...
cfg_fusion    = dict(use_film=False, use_aux=False, use_attention=True)   # 对应调整模型


# ======= 结果文件夹自动归类 =======
save_root = f"/home/guests/yilin_tang/Unet Fusion model v6/epi_results/{exp_name}"
